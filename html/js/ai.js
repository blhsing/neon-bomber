...
function powerUtility(p,id){switch(id){case'bomb':return p.bombsMax<4?1.35:.5;case'fire':return p.range<5?1.25:.55;case'speed':return p.speed<4.2?1.3:.55;case'heart':return p.hp<3?1.55:.45;case'shield':return p.shield<2?1.5:.55;case'flamepass':return p.flamepass?.2:1.8;case'remote':return p.remote?.3:1.55;case'disguise':return p.disguise?.3:1;case'kick':return p.kick?.35:1.25;case'glove':return p.glove?.4:1.2;case'bombpass':return p.bombpass?.35:1.15;case'wallpass':return p.wallpass?.35:1.1;case'dash':return 1.15;case'mega':case'cluster':case'freeze':return 1.35;case'mystery':return .8;default:return 1}}
